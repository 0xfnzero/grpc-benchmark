...
# 创建目录
echo "创建目录..."
mkdir -p /root/grpc-benchmark
cd /root/grpc-benchmark
...
echo "   vim run-latency-test.sh"
echo "   vim run-grpc-comparison.sh"
echo "   vim run-benchmark-jito.sh"
echo "   vim run-grpc-vs-fzstream.sh"
echo ""
echo "2. 运行测试："
echo "   ./run-latency-test.sh"
echo "   ./run-grpc-comparison.sh"
echo "   ./run-benchmark-jito.sh"
echo "   ./run-grpc-vs-fzstream.sh"
echo ""
echo "3. 查看帮助信息："
echo "   ./latency-test --help"
echo "   ./grpc-comparison --help"
echo "   ./benchmark-jito --help"
echo "   ./grpc-vs-fzstream --help"
echo ""
